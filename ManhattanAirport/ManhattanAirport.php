...
<body>
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
            <a class="navbar-brand" href="ManhattanAirport.php">Manhattan Airport</a>
...
status as 'Status' 
from flights 
WHERE startAirport = 'ManhattanAirport' and date(departureTime) ="."'".$_SESSION['currentDate']."';");
...
status as 'Status' 
from flights 
WHERE endAirport = 'ManhattanAirport' and date(arrivalTime) =". "'".$_SESSION['currentDate']."';"); 
        ...
        <footer class="page-footer font-small indigo">
            <div class="footer text-center py-3">ManhattanAirport
            </div>
        </footer>
        <!-- Footer -->
