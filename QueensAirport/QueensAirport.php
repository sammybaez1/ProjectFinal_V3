...
<body>
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-warning">
            <a class="navbar-brand" href="QueensAirport.php">Queens Airport</a>
...
status as 'Status' 
from flights 
WHERE startAirport = 'QueensAirport' and date(departureTime) ="."'".$_SESSION['currentDate']."';");
...
status as 'Status' 
from flights 
WHERE endAirport = 'QueensAirport' and date(arrivalTime) =". "'".$_SESSION['currentDate']."';"); 
        ...
        <footer class="page-footer font-small indigo">
            <div class="footer text-center py-3">QueensAirport
            </div>
        </footer>
        <!-- Footer -->
